    ...
    */
    public class InMemoryTransactionRepository : ITransactionRepository
    {
        ...
        public void CreateTransaction(User sender, User receiver, double amount)
        {
            ...
            user_repository.SetUserBalance(user_repository.GetUserById(sender.id), newSenderBalance);
            user_repository.SetUserBalance(user_repository.GetUserById(receiver.id), newReceiverBalance);
        ...
        public void RevertTransaction(Guid id)
        {
            ...
            var userSender = user_repository.GetUserById(transaction.sender);
            var userReceiver = user_repository.GetUserById(transaction.receiver);
